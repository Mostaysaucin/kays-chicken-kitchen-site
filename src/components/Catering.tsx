export default function Catering() {
  const features = [
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--secondary)" strokeWidth="1.5" strokeLinecap="round">
        ...
        <div className="text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              <a href="mailto:kayssmokehouse@gmail.com" className="flex items-center gap-2 text-sm font-bold transition-colors" style={{ color: "var(--secondary)" }}>
              ...
              <a href="tel:8138930415" className="flex items-center gap-2 text-sm font-bold transition-colors" style={{ color: "var(--secondary)" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <div>
            <a href="mailto:kayssmokehouse@gmail.com" className="btn-primary">
