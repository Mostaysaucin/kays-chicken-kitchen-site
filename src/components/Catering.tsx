export default function Catering() {
  const features = [
    {
      icon: (
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#FFD700" strokeWidth="1.5" strokeLinecap="round">
    ...
    <section id="catering" className="section-padding" style={{ background: "var(--bg-dark)" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            Catering for <span style={{ color: "var(--gold)" }}>Any Occasion</span>
          </h2>
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <h3
                ...
                style={{ fontFamily: "var(--font-heading)", fontWeight: 700, color: "white", textTransform: "uppercase", letterSpacing: "0.05em" }}
              >
                {feature.title}
              </h3>
